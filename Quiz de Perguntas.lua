...
"Em qual país está situado o host de baixo ping disponível para os usuários brasileiros?","Canadá","México",1,
...
"Qual comando serve para ver a versão do Transformice?","/version","/^^",1,
...
"Quantos modules oficiais existem no Transformice?","46","47",1,
...
"Qual é o nome da tribo oficial da equipe FunCorp BR/PT?","Alaranjados","Funcrepe",1,
...
"Quantos queijos no perfil são necessários para desbloquear o título 'Obaaaaa Queijo ^^'?","100","200",1,
...
"O Transformice possui mais de 8 milhões de mapas criados.","Verdadeiro","Falso",2,
...
"A habilidade 'Invocador Mestre' faz parte de qual árvore de habilidades?","Mecânico","Físico",1,
}
perguntas1={
"Vai na sorte :)","ok","ok",1,
"Vai na sorte :)","ok","ok",2,
...
"Qual o nome do planeta-anão situado no Cinturão de Asteroides, com características similares a de Plutão?","Calisto","Ceres",2,
...
"Em que ano o estado do Acre foi comprado pelo Brasil?","1903","1915",1,
"Qual foi o nome do tratado de paz que deu final a Primeira Guerra Mundial?","Tratado de Tordesilhas","Tratado de Versalhes",2,
"Em qual ano estreou a rede social Facebook?","2004","2006",1,
"Qual o nome dado para as pessoas que são do estado do Espírito Santo?","Potiguar","Capixaba",2,
"Qual o nome da forma e sistema de governo onde há um Presidente e um Primeiro Ministro ao mesmo tempo?","República Parlamentarista","República Presidencialista",1,
"Qual o único lívro da Bíblia Sagrada que possui apenas um capítulo?","Malaquias","Obadias",2,
"Em qual ano a Intel lançou o seu primeiro processador da linha Pentium?","1993","2000",1,
...
"Qual o nome dado para as pessoas que são da cidade de Manaus?","Manauense","Manauara",2,
"Qual o nome do 'vão' entre a América do Sul e a Antártida, onde pouquíssimos navios passam devido às condições atmosféricas adversas?","Passagem de Gibraltar","Passagem de Drake",2,
}
perguntas2={
"Vai na sorte :)","ok","ok",1,
"Vai na sorte :)","ok","ok",2,
...
numbers1={{72,119,101,105,35,49,48,50,55},
...
function eventNewGame()
	...
	for name,player in next,tfm.get.room.playerList do
		...
		if name:sub(1,1) == "*" then
		   	...
		   	showMessage("<R>Jogadores convidados não podem participar deste jogo. Faça login em uma conta para jogar.",name)
		end
	end
	if tema == 0 then
...
function eventChatCommand(name,message)
	if verifyNinjas(name) == true or verifyAdmin(name) == true then
		...
		if (message:sub(0,4) == "tema") then
			tt={}; for i=0,2 do table.insert(tt,tostring(i)) end
...
function randomQuests()
	for name,player in next,tfm.get.room.playerList do
		tfm.exec.movePlayer(name,400,200,false)
	end
